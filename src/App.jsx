...
import GraduacaoForm from "./pages/GraduacaoForm";
        ...
        <Routes>
          ...
          <Route element={<RotaPrivada />}>
            <Route element={<LayoutPrivado />}>
              ...
              {/* GRADUAÇÕES */}
              <Route
                path="/modalidades/:modalidadeId/graduacoes"
                element={<Graduacoes />}
              />

              <Route
                path="/modalidades/:modalidadeId/graduacoes/nova"
                element={<GraduacaoForm />}
              />

              <Route
                path="/modalidades/:modalidadeId/graduacoes/:id"
                element={<GraduacaoForm />}
              />
